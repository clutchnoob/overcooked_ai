...
echo "Run 4: Training PPO_BC for cramped_room seed 0..."
echo "Paper iterations: 550"

# Uses BC models from bc_runs_run4/train/cramped_room/
python -m human_aware_rl.ppo.train_ppo_bc --layout cramped_room --seed 0 --bc_model_base_dir human_aware_rl/bc_runs_run4/train --results_dir results/ppo_bc_run4

echo "PPO_BC training complete for cramped_room seed 0"
