...
echo "Run 4: Training PPO_SP for asymmetric_advantages seed 20..."
echo "Paper iterations: 650"

python -m human_aware_rl.ppo.train_ppo_sp --layout asymmetric_advantages --seed 20 --results_dir results/ppo_sp_run4

echo "PPO_SP training complete for asymmetric_advantages seed 20"
