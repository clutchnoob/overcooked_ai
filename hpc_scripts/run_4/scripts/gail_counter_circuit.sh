...
echo "Run 4: Training GAIL model for counter_circuit..."

python -m human_aware_rl.imitation.gail --layout counter_circuit --results_dir human_aware_rl/gail_runs_run4
