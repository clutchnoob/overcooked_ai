...
#SBATCH --output=../logs/ppo_gail_run4/ppo_gail_asymmetric_advantages_seed20_%j.out
#SBATCH --error=../logs/ppo_gail_run4/ppo_gail_asymmetric_advantages_seed20_%j.err
