...
echo "Run 4: Training PPO_SP for counter_circuit seed 10..."
echo "Paper iterations: 650"

python -m human_aware_rl.ppo.train_ppo_sp --layout counter_circuit --seed 10 --results_dir results/ppo_sp_run4

echo "PPO_SP training complete for counter_circuit seed 10"
